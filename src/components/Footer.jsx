import { BracketsCurly, FacebookLogo, InstagramLogo, LinkedinLogo, TwitterLogo } from "phosphor-react";
    ...
    <footer className="text-gray-400 body-font absolute bottom-0 flex justify-between w-full">
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        ...
        <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
          <a  href="https://www.facebook.com/profile.php?id=100038417583504" className="text-gray-400">
